...
lightcurve = "data/unzipped/EB_Q1_long/kplr001026032-2009166043257_llc.fits"
...
def concatenate_fits(data_path, list_of_filenames, out_path, out_name):
    ...
    combined.write(out_path + "/" + out_name, overwrite="True")


print([i for i in os.walk("data/combined")])
